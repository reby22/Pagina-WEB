<?php 
    ...
    $consulta1 = "SELECT * FROM catalogo";
        ...
        <div class="capitulosManga">
            ...
            <table class="capitulos">
                ...
                <?php while ($row1 = mysqli_fetch_array($query1)) {
                    ...
                    <td> <?php echo $row1['Nombre']; ?></a> </td>
                    <td> <?php echo $row1['resumen']; ?></a> </td>
                    <td> <?php echo $row1['imagen']; ?></a> </td>
                    <td><button><a href="./logica/eliminaManga.php?id_C= <?php echo $row1['id_manga'];?>">Eliminar</a></button></td>
                </tr>
                <?php } ?>
                </tbody>
            </table>
